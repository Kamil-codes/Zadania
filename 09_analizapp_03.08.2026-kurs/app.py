...
def analizuj():
    ...
    try:
        ...
        return render_template(
            "analiza.html",
            blad=(
                "Nie udało się odczytać pliku. Sprawdź, czy plik CSV/Excel nie jest uszkodzony i czy zawiera tabelę z nagłówkami kolumn. Następnie spróbuj przesłać go ponownie."
            )
        )
